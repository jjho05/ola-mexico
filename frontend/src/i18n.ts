...
const resources = {
  en: {
    translation: {
      ...
      ,"select_suggestion": "Pick one option from the list to set the exact point."
      ,"tourist_map_title": "City map"
      ,"tourist_map_help": "Discover famous places and nearby local businesses."
      ,"tourist_map_cta": "Use my location"
      ,"tourist_map_empty": "Save your location or tap “Use my location” to load the map."
      ,"tourist_map_loading": "Loading map..."
      ,"tourist_map_error": "Could not load map."
      ,"tourist_map_no_geo": "Geolocation not available."
      ,"tourist_places": "Famous places"
      ,"tourist_places_empty": "No places found."
      ,"tourist_locales": "Local businesses"
      ,"tourist_locales_empty": "No nearby businesses yet."
      ,"tourist_insights": "Insights"
      ,"tourist_insight_places": "Places"
      ,"tourist_insight_locales": "Locales"
      ,"tourist_insight_topcat": "Top category"
      ,"tourist_insight_none": "N/A"
      ,"tourist_route_title": "Authentic route"
      ,"tourist_route_empty": "Swipe to personalize your route."
      ,"tourist_route_based": "Based on"
  ...
  es: {
    translation: {
      ...
      ,"select_suggestion": "Selecciona una opción de la lista para fijar el punto exacto."
      ,"tourist_map_title": "Mapa de la ciudad"
      ,"tourist_map_help": "Descubre lugares famosos y negocios locales cercanos."
      ,"tourist_map_cta": "Usar mi ubicación"
      ,"tourist_map_empty": "Guarda tu ubicación o toca “Usar mi ubicación” para cargar el mapa."
      ,"tourist_map_loading": "Cargando mapa..."
      ,"tourist_map_error": "No se pudo cargar el mapa."
      ,"tourist_map_no_geo": "Geolocalización no disponible."
      ,"tourist_places": "Lugares famosos"
      ,"tourist_places_empty": "No se encontraron lugares."
      ,"tourist_locales": "Locales cercanos"
      ,"tourist_locales_empty": "Aún no hay locales cerca."
      ,"tourist_insights": "Insights"
      ,"tourist_insight_places": "Lugares"
      ,"tourist_insight_locales": "Locales"
      ,"tourist_insight_topcat": "Categoría top"
      ,"tourist_insight_none": "N/D"
      ,"tourist_route_title": "Ruta auténtica"
      ,"tourist_route_empty": "Haz swipes para personalizar tu ruta."
      ,"tourist_route_based": "Basado en"
